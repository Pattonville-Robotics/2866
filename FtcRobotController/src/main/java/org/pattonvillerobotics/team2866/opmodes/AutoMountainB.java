...
public class AutoMountainB extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        drive.moveInches(Direction.FORWARDS, 30, 1); //Up to the mountain bit
        drive.rotateDegrees(Direction.RIGHT, 135, 1); //rotate to face mountain
        drive.moveInches(Direction.FORWARDS, 134.62, 1); //Moves up to mountain
        climbAssist.moveChain(1);
        drive.moveInches(Direction.FORWARDS, 124.46, 1); //Measurement required
