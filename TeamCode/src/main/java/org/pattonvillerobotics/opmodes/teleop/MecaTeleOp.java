...
public class MecaTeleOp  extends LinearOpMode {
    ...
    private void initialize() {
        ...
        driveGamepad.addButtonListener(GamepadData.Button.Y, ListenableButton.ButtonState.JUST_PRESSED, () -> lowPowerMode = !lowPowerMode);
        armGamepad.addButtonListener(GamepadData.Button.DPAD_UP, ListenableButton.ButtonState.JUST_PRESSED, () -> lunex.partialExtendForearm(0.5));
        armGamepad.addButtonListener(GamepadData.Button.DPAD_DOWN, ListenableButton.ButtonState.JUST_PRESSED, () -> lunex.partialFlexForearm(0.5));
        armGamepad.addButtonListener(GamepadData.Button.DPAD_LEFT, ListenableButton.ButtonState.JUST_PRESSED, () -> lunex.partialExtendBicep(0.5));
        armGamepad.addButtonListener(GamepadData.Button.DPAD_RIGHT, ListenableButton.ButtonState.JUST_PRESSED, () -> lunex.partialExtendBicep(0.5));
        armGamepad.addButtonListener(GamepadData.Button.A, ListenableButton.ButtonState.JUST_PRESSED, () -> lunex.rotateWaist(90));
