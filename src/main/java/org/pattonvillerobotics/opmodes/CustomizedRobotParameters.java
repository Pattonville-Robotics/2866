...
public class CustomizedRobotParameters {
    ...
    static {
        ...
        VUFORIA_PARAMETERS = new VuforiaParameters.Builder()
                ...
                .addBeaconLocation(0 * MM_PER_INCH, 0 * MM_PER_INCH, 0 * MM_PER_INCH, AxesOrder.XYZ, 90, 0, -90) //Wheels
                .addBeaconLocation(36 * MM_PER_INCH, 72 * MM_PER_INCH, 0 * MM_PER_INCH, AxesOrder.XYZ, 90, 0, 0) //Tools
                .addBeaconLocation(0 * MM_PER_INCH, 0 * MM_PER_INCH, 0 * MM_PER_INCH, AxesOrder.XYZ, 90, 0, -90) //Legos
