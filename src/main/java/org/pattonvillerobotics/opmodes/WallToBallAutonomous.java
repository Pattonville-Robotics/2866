...
public final class WallToBallAutonomous {
    ...
    @Autonomous(name = "RED Tile 3 to Ball", group = OpModeGroups.MAIN)
    public static final class RedTile3 extends LinearOpMode {
        @Override
        public void runOpMode() throws InterruptedException {
            ...
            encoderDrive.moveInches(Direction.FORWARD, 60, .75);
        }
    }

    @Autonomous(name = "BLUE Tile 3 to Ball", group = OpModeGroups.MAIN)
    public static final class BlueTile3 extends LinearOpMode {
        @Override
        public void runOpMode() throws InterruptedException {
            final EncoderDrive encoderDrive = new EncoderDrive(hardwareMap, this, CustomizedRobotParameters.ROBOT_PARAMETERS);
            waitForStart();
